...
if __name__ == "__main__":
    study = optuna.create_study(direction="maximize", study_name="SpanishTweetsCLF_ideology_binary", load_if_exists=True)
    ...
    with open("ideology_binary_trial_results.txt", "w") as file:
        for trial in trials:
    ...
    with open("best_hyperparams_ideology_binary.yaml", "w") as f:
        yaml.dump(best_hyperparams, f)
        
        print(f"The best hyperparameters are saved in 'best_hyperparams_ideology_binary.yaml'." )
